...
namespace Lamina {
	LAMINA_FUNC("inf", LaminaRange::lamina_inf, 0);
	LAMINA_FUNC("neginf", LaminaRange::lamina_neginf, 0);
	LAMINA_FUNC("ranges", LaminaRange::lamina_range, 2);
	LAMINA_FUNC("rangex", LaminaRange::lamina_rangex, 4);
	LAMINA_FUNC_WIT_ANY_ARGS("intersect", LaminaRange::lamina_intersect);
	LAMINA_FUNC_WIT_ANY_ARGS("join", LaminaRange::lamina_join);
	LAMINA_FUNC("in_range", LaminaRange::lamina_range_test, 2);
}
